defmodule IntellectualClub.Bots.Calculations.BlocksCount do
  @moduledoc """
  Knowledge block binding count for already-authorized bot records.
  """
  ...
  def calculate(records, _opts, _context) do
    ...
    counts =
      if bot_ids == [] do
        ...
        sql = """
        SELECT bot_id, COUNT(*) AS blocks_count
        ...
        Map.new(rows, fn [bot_id, blocks_count] ->
          {
            bot_id,
