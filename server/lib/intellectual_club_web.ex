defmodule IntellectualClubWeb do
  @moduledoc """
  ...
  defp html_helpers do
    quote do
      ...
      import Phoenix.HTML
      # Core UI components
      import IntellectualClubWeb.CoreComponents

      # Common modules used in templates
      alias Phoenix.LiveView.JS
      alias IntellectualClubWeb.Layouts
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: IntellectualClubWeb.Router,
        statics: IntellectualClubWeb.static_paths()
    end
  end
