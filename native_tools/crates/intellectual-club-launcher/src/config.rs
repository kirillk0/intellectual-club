...
impl Locale {
    ...
    pub fn text(self, key: TextKey) -> &'static str {
        match (self, key) {
            ...
            (Self::Ru, TextKey::Administrators) => "Администраторы",
            (Self::Ru, TextKey::CreateAdministrator) => "Создать администратора",
            (Self::Ru, TextKey::AdministratorHelp) => {
                "Создаёт нового администратора. Существующие пользователи не изменяются."
            }
            (Self::Ru, TextKey::Username) => "Логин",
            (Self::Ru, TextKey::Password) => "Пароль",
            (Self::Ru, TextKey::ConfirmPassword) => "Подтверждение пароля",
            (Self::Ru, TextKey::PasswordsDoNotMatch) => "Пароли не совпадают",
            (Self::Ru, TextKey::AdministratorCreated) => "Администратор создан",
            (Self::Ru, TextKey::AdministratorCreationFailed) => "Не удалось создать администратора",
            ...
            (Self::En, TextKey::Administrators) => "Administrators",
            (Self::En, TextKey::CreateAdministrator) => "Create administrator",
            (Self::En, TextKey::AdministratorHelp) => {
                "Creates a new administrator. Existing users are not changed."
            }
            (Self::En, TextKey::Username) => "Username",
            (Self::En, TextKey::Password) => "Password",
            (Self::En, TextKey::ConfirmPassword) => "Confirm password",
            (Self::En, TextKey::PasswordsDoNotMatch) => "Passwords do not match",
            (Self::En, TextKey::AdministratorCreated) => "Administrator created",
            (Self::En, TextKey::AdministratorCreationFailed) => "Failed to create administrator",
