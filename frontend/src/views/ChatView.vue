    ...
    <div class="split-wrapper">
      <div class="split" :style="{ gridTemplateColumns: vm.gridColumns }" style="min-height: 70vh">
        ...
        <ChatLibrarySidebar
          ...
          :new-chat-tool-instance-id="vm.newChatToolInstanceId"
          :new-chat-tool-alias="vm.newChatToolAlias"
          ...
          @update:newChatToolInstanceId="(value) => (vm.newChatToolInstanceId = value)"
          @update:newChatToolAlias="(value) => (vm.newChatToolAlias = value)"
